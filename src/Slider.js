  ...
  constructor(props) {
    ...
    document.addEventListener("mousemove", (e) => {
      ...
      if (this.state.sliderActive) {
        let futureHue =
          this.state.baseHue + (e.clientX - this.state.basePos) * 2;
    ...
    document.addEventListener("mouseup", (e) => {
      if (this.state.sliderActive)
        this.setState({ sliderActive: false, baseHue: this.state.hue });
    });
  }
  render() {
    ...
    return (
      <div id="sliderContainer">
        <div id="colorSlider" onMouseDown={this.handleClick}>
          <div
            id="sliderDot"
            style={{ left: (this.state.hue - this.props.startingHue) / 2 - 20 }}
          >
